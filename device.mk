...
$(call inherit-product-if-exists, vendor/xiaomi/msm8998-common/msm8998-common-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/selective-spn-conf.xml:$(TARGET_COPY_OUT_VENDOR)/etc/selective-spn-conf.xml
